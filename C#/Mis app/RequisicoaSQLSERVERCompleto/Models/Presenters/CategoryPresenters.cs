    ...
    public class CategoryPresenters
    {
        ...
        public void Central()
        {
            ...
            //{
               ...
               var valorRef = view2.ComboBox2Form3.SelectedItem.ToString();
                ...
                if ( valorEntid != null && valorCate != null && valorRef !=null)
                 {
                   ...
                   // Requisição Interna
                    ...
                    //{
                         bo b = new bo
                            {
                              bostamp = base64Guid , nmdos = "RI", obrano = numeroDo, dataobra = DateTime.Now,  nome = valorEntidad, tipo = "Interno", datafinal = DateTime.Now, boano =voano, dataopen =DateTime.Now, datafecho = DateTime.Now,
                          ...
                          bi[] miObj = new bi[count];
                             ...
                             for (int i = 0; i < view2.DataGridForm3.Rows.Count; i++)
                             {
                                ...
                                using (DBConnect db = new DBConnect())
                                {
                                  ...
                                  miObj[i] = new bi
                                 {
                                  bistamp = uidBi, nmdos = "RI", obrano = numeroDo, _ref = cell1, design = cell2, qtt = cell3, serie = "n", fdata = DateTime.Now, nmdoc = "n", forref = "n", rdata = DateTime.Now, dedata = DateTime.Now,
                ...
                {
                 MessageBox.Show("Valor vacio em Entidad/Categoria/Ref ***");
                }
            //}
           //catch
           // {
        ...
        public void SearchIdRefPesquisa(string x)
        {
            ...
            try
            {
                ...
                {
                    // habla.Falar("Ref esta vacia");
                    MessageBox.Show("Categoria esta vacia");
                }
